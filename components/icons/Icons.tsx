...
export const BrainIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.528 1.528A.5.5 0 0110 2h4a.5.5 0 01.472.528l.5 4a.5.5 0 01-.472.528h-4.944a.5.5 0 01-.472-.528l.5-4a.5.5 0 01.472-.528zM12 11a1 1 0 100-2 1 1 0 000 2z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.5V7m0 7v2.5m-3.5-5.05L6.343 9.793m11.314 0l-2.157 2.157m-9.157 5.107l-2.157-2.157M19.657 17.5l-2.157-2.157" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 21a9 9 0 100-18 9 9 0 000 18z" />
  </svg>
);

export const ComputerIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const NetworkIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.846 13.654 9 14.004 9 14.375c0 .966-.394 1.84-1.031 2.469m-1.938-2.469C5.438 13.84 5 14.714 5 15.687c0 .973.438 1.847 1.031 2.47M15.316 13.342c.162.312.316.662.316 1.033 0 .966-.394 1.84-1.031 2.469m-1.938-2.469c.593.629 1.031 1.503 1.031 2.47 0 .973-.438 1.847-1.031 2.47M9 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H9a2 2 0 01-2-2V5z" />
  </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-9l2-2 2 2m-2 5V7m-5 5l-2 2-2-2-2m2-5v5" />
    </svg>
);
...
export const BookmarkIcon: React.FC<IconProps & { solid?: boolean }> = ({ className = 'w-6 h-6', solid = false }) => (
    <svg className={className} fill={solid ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
